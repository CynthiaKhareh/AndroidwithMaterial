...
public class Teacher6Login extends AppCompatActivity {
    EditText Username,Password;
    Button Login;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_teacher6_login);
        ...
        Login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(Username.getText().toString().equals("aicndarakwacdc")&& Password.getText().toString().equals("@Ndarakwa2020CDC")){
                    startActivity(new Intent(Teacher6Login.this,Teacher6.class));
                }
                else {
